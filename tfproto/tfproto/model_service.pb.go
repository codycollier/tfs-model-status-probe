...
var file_model_service_proto_rawDesc = []byte{
	...
	,
}

var file_model_service_proto_goTypes = []interface{}{
	(*GetModelStatusRequest)(nil),  // 0: tfproto.GetModelStatusRequest
	(*GetModelStatusResponse)(nil), // 1: tfproto.GetModelStatusResponse
}
var file_model_service_proto_depIdxs = []int32{
	0, // 0: tfproto.ModelService.GetModelStatus:input_type -> tfproto.GetModelStatusRequest
	1, // 1: tfproto.ModelService.GetModelStatus:output_type -> tfproto.GetModelStatusResponse
...
func (c *modelServiceClient) GetModelStatus(ctx context.Context, in *GetModelStatusRequest, opts ...grpc.CallOption) (*GetModelStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tfproto.ModelService/GetModelStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ModelService_GetModelStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tfproto.ModelService/GetModelStatus",
	}
...
var _ModelService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tfproto.ModelService",
